...
hooking::hooking() :
	...
	m_dispatchEvent("DE", pointers::g_dispatchEvent, &hooks::dispatchEvent, false),
	...
	m_receiveCloneSync("RCS", pointers::g_receiveCloneSync, &hooks::receiveCloneSync, false),
	m_receiveCloneCreate("RCC", pointers::g_receiveCloneCreate, &hooks::receiveCloneCreate, false),
	m_canApplyData("CAD", pointers::g_canApplyData, &hooks::canApplyData, false),
	...
	m_hasRosPrivilege("HRP", pointers::g_hasRosPrivilege, &hooks::hasRosPrivilege, false),
	m_insertStreamingModule("ISM", pointers::g_insertStreamingModule, &hooks::insertStreamingModule, false),
